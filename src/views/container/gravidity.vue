<template>
  <div class="gravidity">
    ...
    <div class="con">
      ...
      <v-stage ref="stage" :config="stageSize" class="canvas">
        <v-layer>
          ...
          <v-shape :config="redCircle" :preventDefault="false" ref="redAnim"/>
      ...
      <div class="res">
        ...
        <div class="tips" :key="index">
          ...
          <a href="https://wapbaike.baidu.com/item/%E4%BA%BA%E7%BB%92%E6%AF%9B%E8%86%9C%E4%BF%83%E6%80%A7%E8%85%BA%E6%BF%80%E7%B4%A0?adapt=1" target="_blank">(点击查询专业知识)</a>
        </div>
        </template>
      </div>
    </div>
    ...
    <div class="btns">
      <mt-button size="large" type="primary" class="btn" @click="abnormalDete">异常检测</mt-button>
...
const scaleValue = ["0", "12.5", "25", "50", "500", "5000", "10000"]
  ...
  export default {
    ...
    data() {
      return {
        ...
        image: null,
        imageX: width/2-originW*0.6/2.5,
        imageY: 200-originH*0.6/2,
        imageW: originW*0.6,
        imageH: originH*0.6,
        result: '',
        isSummary: false,
        ...
        redCircle: {
          sceneFunc: function(context, shape) {
            ...
            // redValue = Number(redValue.toPrecision(3))
            ...
            //   context.beginPath();
            //   context.arc(width/2, 200, 100, 2.45, redValue, false);
            //   redValue = Number((redValue + speed).toPrecision(3))
            //   console.log(redValue)
            //   context.moveTo(65, 65);
            //   context.closePath();
            //   context.fillStrokeShape(shape);
            ...
            //   }
            //   if(redValue == 0.65) {
            //     window.clearInterval(this.timerUp)
            //     this.timerUp = null
            //     console.log('stop111111111111111111111111')
            //   }
            // }, 100)
          },
          stroke: '#ffffff',
    ...
    created() {
      ...
      image.src = require('../../assets/yunfu.png');
      image.onload = () => {
